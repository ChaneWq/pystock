...
class StockMonitorGUI:
	...
	def setup_fonts(self):
		"""设置字体"""
		self.title_font = tkfont.Font(family="Microsoft YaHei", size=8, weight="bold")
		self.normal_font = tkfont.Font(family="Microsoft YaHei", size=8)
		self.bold_font = tkfont.Font(family="Microsoft YaHei", size=8, weight="bold")
		self.large_font = tkfont.Font(family="Microsoft YaHei", size=8, weight="bold")
	...
	def create_widgets(self):
		...
		control_frame.pack(fill=tk.X, pady=(0, 10), ipadx=5, ipady=2)
	...
	def update_stock_count(self):
		...
		self.count_label.config(text=f"数量: {len(self.stock_data)}")
	...
	def start_monitoring(self):
		...
		self.status_label.config(text="ing...")
