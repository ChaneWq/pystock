	...
	try:
		...
		for col in df.columns:
			...
			if dtype.startswith('int'):
				...
				varchar_length = max(50, min(max_length + 10, 500))  # 限制在500以内
...
if __name__ == "__main__":
	...
	csv_file_path = r'C:\Users\82169\Desktop\stock_data\gn\test20250928.xls.xlsx'  # 替换为你的CSV文件路径
	mysql_table_name = 'tmp_shop'  # 替换为你想要的表名
