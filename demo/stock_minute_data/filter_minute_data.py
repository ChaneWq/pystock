...
df_final = df_renamed[['open', 'close', 'high', 'low', 'vol', 'amount', 'trade_date', 'hour', 'minute', 'volume']]

# 保存为CSV到data目录
df_final.to_csv('data/000400_filtered.csv', index=False)